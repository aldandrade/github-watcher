...
- [ ] Add an email address to the `ADMINS` settings variable in `github_aldant/github_aldant/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `github_aldant/github_aldant/settings/production.py`
...
- Create a copy of ``github_aldant/settings/local.py.example``:
  `cp github_aldant/settings/local.py.example github_aldant/settings/local.py` (remembering you should replace `github_aldant` with your project's name!).
